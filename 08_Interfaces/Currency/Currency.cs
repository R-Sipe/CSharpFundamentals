...
namespace _08_Interfaces.Currency
{
    ...
    {
        //without a set or private set on value, we can only set value when making the objects in consturctor
        //with this consturcotr we block the use of the empty constructor
